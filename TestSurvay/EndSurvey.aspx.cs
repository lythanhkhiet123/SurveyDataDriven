    ...
    public partial class EndSurvey : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < list.Count; i++)
            {
                ...
                {
                    string sql = "INSERT INTO Answer (q_id, answer, respondent_id, respondent_ip,respondent_date) VALUES(" + list2[i] + ",'" + list[i] + "','" + id + "','" + GetIPAddress() + "','" + dateSurvey.ToString("yyyy-MM-dd") + "'); ";
