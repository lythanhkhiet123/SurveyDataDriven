    ...
    public partial class searchPage : System.Web.UI.Page
    {
        ...
        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                {
                    sql = "select * from Answer where person_answer =( select CONVERT(varchar(20),id) from registeredUsers where firstname like '%" + TextBox1.Text + "%' or lastname like '%" + TextBox1.Text + "%' )";
                }
